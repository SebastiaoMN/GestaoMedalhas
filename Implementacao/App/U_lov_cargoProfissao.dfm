object Frm_lov_CargoProfissao: TFrm_lov_CargoProfissao
  Left = 280
  Top = 317
  Width = 641
  Height = 368
  Caption = 'Consulta Cargo / Profiss'#227'o'
  Color = clBtnFace
  ...
  object DBGridPesquisa: TDBGrid
    ...
    Height = 245
    Align = alClient
    DataSource = DSConsCargoProfissao
    FixedColor = clGray
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object QConsCargoProfissao: TQuery
    DatabaseName = 'SCM'
    SQL.Strings = (
      'SELECT codigo,'
      '       descricao'
      'FROM cargo_profissao'
        ...
        'where (upper(Descricao) like upper( :p_nome ) or :p_nome is null' +
        ')'
      'order by descricao')
    Left = 518
    Top = 47
    ...
    object QConsCargoProfissaoCODIGO: TFloatField
      FieldName = 'CODIGO'
      Origin = 'SCM.AGRACIADOS.CODIGO'
    end
    object QConsCargoProfissaoDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'SCM.CARGO_PROFISSAO.DESCRICAO'
    end
  end
  object DSConsCargoProfissao: TDataSource
    DataSet = QConsCargoProfissao
    Left = 488
    Top = 48
  end
end
